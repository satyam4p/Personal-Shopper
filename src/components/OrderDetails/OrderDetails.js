...
export default class CompleteOrderDeatails extends Component {
    ...
    componentWillMount() {
        ...
        var PostObjects = {"ApiName":"PSGetCustomerListForStylist"};
        PostObjects.InputXML = {
         ...
         PostObjects.IsService = "Y";
            ...
            //url: `http://localhost:5000/api`,
            url: `http://207.148.123.221:5000/api`,
            data: JSON.stringify(PostObjects),
            headers: {
                "Content-Type": "application/json",
                // "X-CSRFToken":window.AppInfo.bridgecsrftoken
            }
       ...
       if(!this.state.OrderLines || !this.state.OrderLines.length){
        ...
        if (this.state.OrderLines) {
            ...
            return Orderlines.map((Items, index) => {
                ...
                return (
                    <Card key={index} style={{ width:"80%", marginBottom: "3px", height: "40%",backgroundColor:"rgba(0,0,0,0.03)" }} >
                        <div style={{ marginRight: "9px", marginBottom: "7px" }}>
                           <CardHeader className="CardHeaderClassWide10">
                               <p>{Items.Item.ItemID}</p>
                           </CardHeader>
                            <Row>
                                <Col md="8">


                                    <CardText style={{ textAlign: "left", marginLeft: "5px", fontWeight: "bold",color:"grey" }}>ItemDescription:<CardText style={{ color: "rgba(4,71,132)", display: "inline", fontWeight: "normal"}}> {Items.Item.ItemDesc}</CardText></CardText>

                                    <CardText style={{ textAlign: "left", marginLeft: "5px", fontWeight: "bold" ,color:"grey"}}>Unit Price:<CardText style={{color:"rgba(4,71,132)",fontWeight:"normal",display:"inline"}}> {Items.Item.UnitCost}$</CardText></CardText>
                                    <CardText style={{ textAlign: "left", marginLeft: "5px", fontWeight: "bold",color:"grey" }}>Cutomer Discount: <CardText style={{color:"rgba(4,71,132)",fontWeight:"normal",display:"inline"}}></CardText></CardText>

                                    <CardText style={{ textAlign: "left", marginLeft: "5px", fontWeight: "bold", width: "fit",color:"grey" }}>Line Total:<CardText style={{color:"rgba(4,71,132)",fontWeight:"normal",display:"inline"}}> {Items.Item.UnitCost}$</CardText> </CardText>
                                </Col>
                                <Col md="4">

                                    <CardImg className="ItemImage" src={ItemImg} /><br />

                                    <Button className="ButtonClass" outline color="secondary" style={{ color: "black", width: "70%" }} onClick={() => { this.removeHandler(Items) }}>Remove</Button><br />
        ...
        if (this.state.Item) {
                ...
                return (
                    ...
                    <div style={{ float: "left", width: "45%", marginLeft: "15px", marginTop: "10px" }}>
                        <Card style={{ marginBottom: "5px" }} key={ItemKey}>
                                ...
                                <CardSubtitle className="ProductsCardSubTitle" style={{color:"grey"}}>Size option</CardSubtitle><CardSubtitle style={{color:"rgba(4,71,132)",textAlign:"left"}}>L M S</CardSubtitle>
                                ...
                                <div>
                                    <div style={{ float: "left" }}>
                                        ...
                                        <Button className="ButtonClass" outline color="secondary">{this.state.qty}</Button>
                                        <Button className="ButtonClass" outline color="secondary" style={{ marginLeft: "3px" }} onClick={() => this.handleIncreaseQty()}>+</Button>
                                    </div>
            ...
            return this.state.ItemList.map((ItemId, index) => {
                ...
                return (
                    ...
                    <div style={{ float: "left", width: "45%", marginLeft: "25px", marginTop: "10px" }}>
                        <Card style={{ marginBottom: "5px",backgroundColor:"rgba(0,0,0,0.03)" }} key={ItemKey}>
                                ...
                                || this.props.itemid == "100019" || this.props.itemid == "100132" || this.props.itemid == "100151" ? <p style={{color:"red"}}>Out Of Stock</p> : <p style={{color:"green"}}>InStock</p>}</CardSubtitle><br />
                                 <div>
                                    ...
                                    <Button outline color="secondary" style={{ float: "left", marginBottom: "5px", color: "black" }} onClick={()=>{this.updatedItemDetail(ItemId) }}>Add</Button>
    ...
    render() {
        return (
            <div className="mainDiv" style={{border:"none",backgroundColor:"white"}} >
                ...
                <Container fluid={true}>
                    ...
                    <div  >
                        <Card className="OrderDetails" style={{border:"none",backgroundColor:"white"}}>
                            <Row>
                                <Col sm="3">
                                    ...
                                    <Card body className="detailsCard">
                                        <CardText style={{ textAlign: "left",color:"grey"}}>OrderNo: <p style={{ textAlign: "left", display: "inline", fontWeight: "normal",color:"rgba(4,71,132)"}}>{this.state.OrderDetails.OrderNo}</p></CardText>
                                        <CardText style={{ textAlign: "left" ,color:"grey"}}>Status: <p style={{ textAlign: "left", display: "inline", fontWeight: "normal",color:"rgba(4,71,132)" }}>{this.state.status}</p></CardText>
                                        <CardText style={{ textAlign: "left",color:"grey" }}>OrderDate: <p style={{ textAlign: "left", display: "inline", fontWeight: "normal",color:"rgba(4,71,132)" }}>{this.getOrderDate(this.state.OrderDate)}</p></CardText>
                                        <CardText style={{ textAlign: "left" ,color:"grey"}}>Payment Status: <p style={{ textAlign: "left", display: "inline", fontWeight: "normal",color:"rgba(4,71,132)" }}></p></CardText>
                                    </Card>
                                </Col>
                                <Col sm="3">
                                <CardHeader className="CardHeaderDetails">
                                ...
                                <CardHeader className="CardHeaderDetails">
                                    ...
                                    <Card body className="detailsCard">
                                        <CardText style={{ textAlign: "left" ,color:"grey"}}>Subscription Program:<p style={{ textAlign: "left", display: "inline", fontWeight: "normal",color:"rgba(4,71,132)" }}> {this.state.customerSubscriptionProgram}</p></CardText>
                                        <CardText style={{ textAlign: "left" ,color:"grey"}}>Subscription Type:<p style={{ textAlign: "left", display: "inline", fontWeight: "normal",color:"rgba(4,71,132)" }}> {this.state.ExtnSubscriptionIntervalType}</p></CardText>
                                        <CardText style={{ textAlign: "left",color:"grey"}}>Subscription Start Date:<p style={{ textAlign: "left", display: "inline", fontWeight: "normal",color:"rgba(4,71,132)" }}> {this.getOrderDate(this.state.ExtnSubscriptionDate)}</p> </CardText>
                                        <CardText style={{ textAlign: "left" ,color:"grey"}}>Subscription End Date:<p style={{ textAlign: "left", display: "inline", fontWeight: "normal",color:"rgba(4,71,132)" }}> {this.getOrderDate(this.state.ExtnSubscriptionEndDate)}</p> </CardText>
                                    </Card>
                                </Col>
                                <Col>
                                    <div style={{ width: "60%", marginLeft: "20%" }}>
                                        <Button className="ButtonClass" outline disabled={this.state.Disable} color="secondary" style={{ marginTop: "6px", width: "100%" , marginBottom:"6px"}} onClick={() => { this.handleOnClickSave() }}>Save</Button>
                                        <Button className="ButtonClass" outline disabled={this.state.Disable} color="secondary" style={{ marginTop: "6px",  width: "100%", marginBottom:"6px" }} onClick={()=>{this.sendHandler()}}>Send To Customer</Button><br />
                                        ...
                                        <Button className="ButtonClass" outline disabled={this.state.Disable} color="secondary" style={{ marginTop: "6px",  width: "100%",marginBottom:"6px" }} onClick={() => { this.cancelHandler() }}>Cancel Order</Button><br />
                                        <Button className="ButtonClass" outline disabled={this.state.Disable} color="secondary" style={{ marginTop: "6px", width: "100%",marginBottom:"6px" }} onClick={() => {this.openModel()}}>Customer Preferences</Button>
                                        <Modal  style={{marginTop:"50px"}} isOpen={this.state.modal} >
                                        <ModalHeader style={{backgroundColor:"rgba(4,71,132)",color:"white",height:"60px"}} >Customer Preferences</ModalHeader>
                                        ...
                                        <ModalFooter>
                                        <Button className="ButtonClass" color="success" onClick={()=>this.handleInstructions()} >
                                            Submit
                                            </Button>
                                            <Button className="ButtonClass" color="danger" onClick={()=>this.handleInstructions()}>
                                            Close
                                            </Button>
                                            </ModalFooter>
                                            </Form>
                        ...
                        <Row>
                            <Col md="6">
                                ...
                                <Card className="ItemDetailsCard" >
                                    ...
                                    <CardBody style={{paddingTop:"2%",paddingLeft:"100px",paddingRight:"5px"}}>
                                        {this.MapItemDetails()}
                                    </CardBody>
                                </Card>
                            </Col>
