      ...
      columns =
                    ...
                    return this.state.OrderList.map((orders, index) => {
                        ...
                        return (
                             <tr className="tableRows" key={OrderNo}>
                                        ...
                                        <Link  style={{color:"blueviolet"}} size="xs" to={{ pathname: `/GetCompleteOrderDetails/OrderHeaderKey?customerid=${orders.Extn.ExtnCustomerID}=ohk=${OrderHeaderKey}`,Order:orders }}>
                                        {OrderNo}
                                        </Link> 
                                        </td>
                                        <td>{Status}</td>
        ...
        return(
            ...
            <Card className="headerCard" >
                ...
                <CardHeader style={{float:"left",fontWeight:"bold",fontSize:"1rem"}}>Order Search</CardHeader>
                ...
                <FormGroup>
                    ...
                    <DropdownToggle style={{backgroundColor:"white",color:"blueviolet"}} caret>
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownItem divider />
                        <DropdownItem className="DropDownItem" onClick={this.handleClick.bind(this)} value="1200">Shipped</DropdownItem>
                        <DropdownItem divider />
